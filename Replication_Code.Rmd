...
# Calculate mean squared error
mse_glm_poi_l1 <- mean((predictions - dat_val$acc)^2)
...
alpha <- 0.5
cvfit <- cv.glmnet(x = dat_train_X_matrix, y = dat_dum_train$acc, family = "gaussian", alpha = alpha, relax= TRUE)
...
mse <- mean((predictions_NN - dat_dum_val$acc)^2)
