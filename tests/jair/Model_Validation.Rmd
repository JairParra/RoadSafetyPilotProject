...
preds_rf_tuned <- predict(rf_model_tuned, newdata = dat_val)
...
# Make predictions on the validation set using the tuned model
preds_xgb_tuned <- predict(xgb_model_tuned, newdata = dat_val)
...
final_df <- merge(predictions_sorted_df, inter_names, by = "int_no")
