...
get_description <- function(variable, varnames_dict) {
...
top_positively_correlated$description <- sapply(top_positively_correlated$variable, function(x) get_description(x, varnames_dict))
top_negatively_correlated$description <- sapply(top_negatively_correlated$variable, function(x) get_description(x, varnames_dict))
