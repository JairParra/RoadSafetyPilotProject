...
dat$date_ <- sapply(dat$date_, function(x) {
...
dat$date_ <- reference_date + imputation_data[, "days_since_ref"]

# Optionally, remove the temporary numeric date column
dat$days_since_ref <- NULL

# Print the head of the dataset to check the results
head(dat, 20)
```
